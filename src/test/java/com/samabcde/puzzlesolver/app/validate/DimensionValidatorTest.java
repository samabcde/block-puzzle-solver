...
class DimensionValidatorTest {
    ...
    @CsvSource(
            textBlock =
                    ...
                    """)
    void Given_InvalidInput_When_Validate_ShouldThrowIllegalArgumentException(
            Integer width, Integer height, String validationMessage) {
        DimensionValidator validator = new DimensionValidator();
        IllegalArgumentException exception =
                assertThrows(
                        IllegalArgumentException.class, () -> validator.validate(width, height));
    ...
    @CsvSource(
            textBlock =
                    ...
                    1,1
                    """)
    void Given_ValidInput_When_Validate_ShouldNotThrowIllegalArgumentException(
