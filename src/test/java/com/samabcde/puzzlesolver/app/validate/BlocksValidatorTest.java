...
class BlocksValidatorTest {
    ...
    void Given_InvalidBlocks_When_Validate_Should_ThrowIllegalArgumentException(String[] blocks, String validationMessage) {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> validator.validate(blocks));
        assertEquals(validationMessage, exception.getMessage());
    }

    public static Stream<Arguments> invalidBlocksTestCases() {
        return Stream.of(arguments(new String[]{}, "blocks must not be empty"),
                arguments(new String[]{"$ #", "a", "0,1"}, "below blocks contains character other than '0', '1', ',' [$ #, a]"),
    ...
    public static Stream<Arguments> validBlocksTestCases() {
        return Stream.of(arguments((Object) new String[]{"111111111111111111111111"}),
