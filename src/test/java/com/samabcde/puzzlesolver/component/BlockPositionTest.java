...
class BlockPositionTest {
    ...
    public void getBlock() {
        ...
        BlockPosition blockPosition =
                new BlockPosition(new Dimension(1, 1), block, new Position(0, 0), 0);
    ...
    public void isIntersect() {
        BlockPuzzle blockPuzzle =
                new BlockPuzzle(new Dimension(4, 3), new String[] {"001,111", "1,1111", "111"});
    ...
    public void toStringTest() {
        ...
        assertEquals(
                ...
                1\
                """,
                blockPuzzle.getBlockPositionById(0).toString());
    }
}
