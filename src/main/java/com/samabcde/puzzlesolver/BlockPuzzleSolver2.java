...
public class BlockPuzzleSolver2 {
	private final Logger logger = LoggerFactory.getLogger(BlockPuzzleSolver2.class);
	...
	public BlockPuzzleSolver2(BlockPuzzle blockPuzzle) {
		...
		Collections.sort(blocks, this.blockPossiblePosition.getBlockPrioriyComparator());
	...
	private BitSet getCommonIntersectBlockPositions(List<BlockPosition> blockPositions) {
		...
		// boolean[] isCommonPositionIntersect = null;
		// BitSet isCommonPositionIntersectBitSet = null;
		for (BlockPosition blockPosition : blockPositions) {
//			if (isCommonPositionIntersect == null) {
//				isCommonPositionIntersect = Arrays.copyOf(blockPosition.isPositionIdIntersect,
...
//		List<BlockPosition> remainingOneBlockPositions = new ArrayList<BlockPosition>();
		...
		do {
			hasChange = false;
//			List<BitSet> commonIntersectBlocksBlockPositions = new ArrayList<BitSet>();
//			for (List<BlockPosition> remainingBlockBlockPositions : remainingBlocksBlockPositions) {
//				if (remainingBlockBlockPositions.size() == 1) {
//					remainingOneBlockPositions.add(remainingBlockBlockPositions.get(0));
//				}
			// commonIntersectBlocksBlockPositions.add(getCommonIntersectBlockPositions(remainingBlockBlockPositions));
//			}
...
//			p = true;
//		} else {
//			noPossiblePositionCount[this.solutions.size()]++;
//			return false;
//		}
//		if (!existNotFillablePoint()) {
//
//			// isSolvable &= true;
//			return true;
//		} else {
//			noFillablePointCount[this.solutions.size()]++;
//			return false;
//		}
		// if (p && !f) {
		// pTfFCount[this.solutions.size()]++;
		//
		// }
		// if (!p && f) {
		// pFfTCount[this.solutions.size()]++;
		// }
		// return p&&f;
	}
