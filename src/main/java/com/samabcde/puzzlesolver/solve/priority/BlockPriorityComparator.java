...
public class BlockPriorityComparator implements Comparator<Block> {
    ...
    public BlockPriorityComparator(
            BlockPossiblePosition blockPossiblePosition, BoardFillState boardFillState) {
    ...
    public int compare(Block arg0, Block arg1) {
        ...
        if (possiblePositionCount0 != possiblePositionCount1) {
            return Integer.compare(possiblePositionCount0, possiblePositionCount1);
        }
